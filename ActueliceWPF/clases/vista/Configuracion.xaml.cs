    ...
    public partial class Configuracion : Page
    {
        ...
        private void alApretar_B_ImportarDirecciones_Propias(object sender, RoutedEventArgs e)
        {
            ...
            if (result== DialogResult.OK)
            {
                ...
                Referencia.manager.importarDireccionesPropias_Subproseso(new FileInfo(ofd.FileName), new EventosEnSubprocesoWPF(
                    () =>
                    {
        ...
        private void alApretar_B_ExportarDirecciones_Propias(object sender, RoutedEventArgs e)
        {
            ...
            if (result.ToString() != string.Empty)
            {
                ...
                Referencia.manager.exportarDireccionesPropias_Subproseso(f, new EventosEnSubprocesoWPF(
                    () =>
                    {
                        dialoghost.IsOpen = false;
                    },
        ...
        private void ComboBox_SelectionChanged_UnidadDiscoDuro_Propia(object sender, SelectionChangedEventArgs e)
        {
            if (dgDireccion.SelectedIndex > -1)
            {
                ...
                if (cb.SelectedItem!=null) {
                    ...
                    string seleccionado = (string)cb.SelectedValue;

                    Referencia.manager.supr(
                        getEV_Dlg(
                        ...
                        if (sj!=null&&seleccionado!=null) {

                            dir.direccion = sj;
                            Referencia.manager.updateDireccionesPropias(Parse(dir));
                            dir.unidad = seleccionado;
        ...
        private EventosEnSubproceso getEV_Principio_Dlg(Action antesDeIniciar, Action a = null)
        {
            return getEV_Principio(antesDeIniciar,() =>
            {
        ...
        {
            return new EventosEnSubprocesoWPF(
                () =>
                {
                    a?.Invoke();
                }
        ...
        private EventosEnSubproceso getEV_Principio(Action antesDeIniciar,Action a = null)
        {
            return new EventosEnSubprocesoWPF(
                 antesDeIniciar
                , () => { a?.Invoke(); }
        ...
        private void alApretar_B_ImportarDirecciones_Paquete(object sender, RoutedEventArgs e)
        {
            ...
            if (result.ToString() != string.Empty)
            {
                ...
                Referencia.manager.importarDireccionesPaquetes_Subproseso(new FileInfo(ofd.FileName), new EventosEnSubprocesoWPF(
                    () =>
                    {
                        dialoghost.IsOpen = false;
        ...
        private void alApretar_B_ExportarDirecciones_Paquete(object sender, RoutedEventArgs e)
        {
            ...
            if (result.ToString() != string.Empty)
            {
                ...
                Console.WriteLine(sfd.FileName);
                FileInfo f = new FileInfo(Archivos.setExtencionStr(sfd.FileName, ".acconf"));
                Referencia.manager.exportarDireccionesPaquete_Subproseso(f, new EventosEnSubprocesoWPF(
                    () =>
                    {
                        dialoghost.IsOpen = false;
                    },
            ...
            if (dgDireccion_Paquete.SelectedIndex > -1)
            {
                ...
                if (cb.SelectedItem != null)
                {
                    ...
                    Referencia.manager.supr(
                        ...
                        if (dir!=null&& sj!=null&& seleccionado!=null) {
        ...
        private void alApretar_B_CargarPaquete(object sender, RoutedEventArgs e)
        {
            ...
            if (success == true)
            {
                ...
                MostrarDialogo();
                Referencia.manager.cargarPaquete(new DirectoryInfo(dir), new EventosEnSubprocesoWPF(() =>
                {
                    ActualizarLista_Paquete();
                    dialoghost.IsOpen = false;
